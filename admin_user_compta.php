<?php
#########################################################################
#                        admin_user_compta.php                         							 #
#                                                                      									 #
#            Interface de modification/ajout/affichage d'une fiche comptable utilisateur     	 #
#                                                                       								#
...
if (isset($user_login) and ($user_login!='')) {
    echo "<h2>".get_vocab('admin_user_compta.php')."</h2>";
} 


?>
<p class=bold>
| <a href="admin_user_modify.php?user_login=<?php echo $user_login; ?>"><?php echo get_vocab("back"); ?></a> |
<a href="admin_user_compta.php?user_login=<?php echo $user_login; ?>&amp;year=<?php echo getSettingValue("default_year"); ?>"><?php echo get_vocab("fiche"); ?></a> |
<br>
</p>
<form action="admin_user_compta.php?display=<?php echo $display; ?>" method='GET'>
...
if ($res) for ($i = 0; ($row = grr_sql_row($res, $i)); $i++)
{
    ...
    $link = "admin_user_compta.php?year=$row[0]&amp;user_login=$user_login";
...
// On appelle les informations de l'utilisateur pour les afficher :
    ...
    if ($res) {
		...
		echo "<td bgcolor='$bgcolor'><a href='admin_user_compta.php?user_modify={$col[$i][0]}&amp;action_copy=yes&amp;user_login=$user_login&amp;year=$user_year '>".get_vocab("copy")."</a></td>";
        ...
        echo "<td><a href='admin_user_compta.php?user_modify={$col[$i][0]}&amp;action_modify=yes&amp;user_login=$user_login&amp;year=$user_year ' onclick='return confirmlink(this, \"$user_login\", \"$themessage\")'>".get_vocab("edit")."</a></td>";
		}
        ...
        echo "<td><a href='admin_user_compta.php?user_del={$col[$i][0]}&amp;action_del=yes&amp;user_login=$user_login&amp;year=$user_year' onclick='return confirmlink(this, \"$user_login\", \"$themessage\")'>".get_vocab("delete")."</a></td>";
		echo "</tr>";
		}
        }
