 ...
 * Affichage des domaines et/ou ressource en fonction des droits d'administrateur (Général, Domaine, Ressource)
 *
...
//if((authGetUserLevel(getUserName(),$area,'area') < 3) OR (authGetUserLevel(getUserName(),$room) < 3))
...
$B = get_vocab("namebooker").get_vocab("deux_points");
...
<TABLE border=\"0\" class=\"calendar\" align=center class=\"EditEntryTable\">
<TR><TD class=\"E\"><B>$B</B></TD></TR>
<TR><TD class=\"CL\"><INPUT NAME=\"name\" SIZE=\"80\" VALUE=\"$C\"></TD></TR>
<TR><TD class=\"E\"><B>$D</B></TD></TR>
<TR><TD class=\"TL\"><TEXTAREA name=\"description\" rows=\"2\" cols=\"80\" WRAP=\"virtual\">$E</TEXTAREA></TD></TR>
<tr><td>\n";
...
// Test si l'utilisateur avec pouvoir est un admin ou un utilisateur administrateur de domaine
<?php
...
<?php
//Affichage de l'area seule si ce n'est pas l'admin de l'area
if (authGetUserLevel(getUserName(),$area,'area') <= 4)
	{
echo "<tr><td class=E><b>".get_vocab("match_area").get_vocab("deux_points")."</b></td></TR><TR><td class=CL valign=top >";
$sql = "select area_name from ".$_COOKIE["table_prefix"]."_area where id='".$area."' order by area_name";
$res = grr_sql_query1($sql);
echo "<tr><td>".$res."</td></TR>";
echo "<INPUT TYPE=HIDDEN NAME=\"areas\" VALUE=\"".$area."\">";
	}
?>
...
echo "\n<!-- ************* Ressources edition ***************** -->\n";
//Affichage de la ou des ressources en fonction des droits
if (authGetUserLevel(getUserName(),$room,'room') > 3)
	{
...
echo "<tr><td class=\"E\"><b>".get_vocab("rooms").get_vocab("deux_points")."</b></td></TR>\n";
$sql = "select room_name from ".$_COOKIE["table_prefix"]."_room where id=$room_id";
$res = grr_sql_query1($sql);
echo "<tr><td>".$res."</td></TR>";
...
if($edit_type == "series")
{
  echo "
    <TR>
       <TD id=\"ouvrir\" onClick=\"clicMenu('1');check_1();\" style=\"cursor: hand\" align=center class=\"fontcolor4\">
       <span class=\"bground\"><B><a href='#'>".get_vocab("click_here_for_series_open")."</a></B></span>
       </TD>
       </TR>
       <TR>
       <TD style=\"display:none\" id=\"fermer\" onClick=\"clicMenu('1')\" style=\"cursor: hand\" align=center class=\"fontcolor4\">
       <span class=\"bground\"><B><a href='#'>".get_vocab("click_here_for_series_close")."</a></B></span>
       </TD>
    </TR>
    ";
