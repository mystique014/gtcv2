Dernière modification du fichier : 20/03/2006

GRR1.9.3
=======================================

Laurent DELINEAU <laurent.delineau@ac-poitiers.fr>
Mathieu Ignacio <mathieu.ignacio@inha.fr>
...
- disposer d'une base de données mysqli (adresse du serveur mysqli, login, mot de passe)
